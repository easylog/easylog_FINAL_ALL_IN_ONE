    ...
    <main className="min-h-screen bg-gray-50 p-6">
      ...
      <div className="max-w-xl mx-auto space-y-4">
        ...
        <div className="flex gap-4">
          <button onClick={startListening} className="bg-green-600 text-white px-4 py-2 rounded">🎤 Start</button>
          <button onClick={stopListening} className="bg-red-600 text-white px-4 py-2 rounded">🛑 Stop</button>
        </div>
        <button
